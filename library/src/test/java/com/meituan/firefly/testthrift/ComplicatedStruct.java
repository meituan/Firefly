...
public class ComplicatedStruct implements org.apache.thrift.TBase<ComplicatedStruct, ComplicatedStruct._Fields>, java.io.Serializable, Cloneable, Comparable<ComplicatedStruct> {
  ...
  private static final org.apache.thrift.protocol.TField BIN_FIELD_DESC = new org.apache.thrift.protocol.TField("bin", org.apache.thrift.protocol.TType.STRING, (short)11);
  ...
  public ComplicatedStruct setBin(byte[] bin) {
    this.bin = bin == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays.copyOf(bin, bin.length));
    return this;
  }

  public ComplicatedStruct setBin(ByteBuffer bin) {
    this.bin = org.apache.thrift.TBaseHelper.copyBinary(bin);
    return this;
  }
  ...
  private static class ComplicatedStructStandardScheme extends StandardScheme<ComplicatedStruct> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ComplicatedStruct struct) throws TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 10: // ORDER_ENUM
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.orderEnum = OrderEnum.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ComplicatedStruct struct) throws TException {
      struct.validate();
      ...
      if (struct.shortSet != null) {
        oprot.writeFieldBegin(SHORT_SET_FIELD_DESC);
        {
          ...
          for (short _iter20 : struct.shortSet)
          {
      ...
      if (struct.mixStructlist != null) {
        oprot.writeFieldBegin(MIX_STRUCTLIST_FIELD_DESC);
        {
          ...
          for (MixStruct _iter22 : struct.mixStructlist)
          {
            _iter22.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.shortList != null) {
        oprot.writeFieldBegin(SHORT_LIST_FIELD_DESC);
        {
          ...
          for (short _iter23 : struct.shortList)
          {
      ...
      if (struct.orderedStructMap != null) {
        oprot.writeFieldBegin(ORDERED_STRUCT_MAP_FIELD_DESC);
        {
          ...
          for (Map.Entry<Short, OrderedStruct> _iter24 : struct.orderedStructMap.entrySet())
          {
            oprot.writeI16(_iter24.getKey());
      ...
      if (struct.mixStructMap != null) {
        oprot.writeFieldBegin(MIX_STRUCT_MAP_FIELD_DESC);
        {
          ...
          for (Map.Entry<Short, MixStruct> _iter25 : struct.mixStructMap.entrySet())
          {
  ...
  private static class ComplicatedStructTupleScheme extends TupleScheme<ComplicatedStruct> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ComplicatedStruct struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ComplicatedStruct struct) throws TException {
